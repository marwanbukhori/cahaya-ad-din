            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <div class="bg-emerald-600 rounded-lg p-1.5">
                            <x-application-logo class="block h-6 w-auto fill-current text-white" />
                        </div>
                        <div class="flex flex-col">
                            <span class="font-bold text-gray-900 leading-tight">Cahaya Ad Din</span>
                            <span class="text-xs text-gray-500">Sistem Pendaftaran</span>
                        </div>
                    </a>
                </div>
            </div>
